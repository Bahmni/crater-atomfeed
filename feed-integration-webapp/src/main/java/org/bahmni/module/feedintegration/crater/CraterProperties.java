...
public class CraterProperties {
    ...
    public String getContent_type() {return getProperty(content_type);}

    public String getAccept() {return getProperty(accept);}

    public String getSetDoOutput() {return getProperty(setDoOutput);}

    public String getSetDoInput() {return getProperty(setDoInput);}

    public String getCurrencyid() {return getProperty(currencyid);}

    public String getUrl() {return getProperty(url);}

    public String getCompany() {return getProperty(company);}

    public String getUsername() {return getProperty(username);}

    public String getPassword() {return getProperty(password);}

    public String getDeviceName(){return getProperty(deviceName);}
